...
void update_cars(){
    //loop through all of the cars and get the current positions and directions
    //increment the posiitons by one in the proper direction
    // add the updated car to the map
    // erase the previous car
}
